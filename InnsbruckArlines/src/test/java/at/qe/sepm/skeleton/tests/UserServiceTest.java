...
public class UserServiceTest {
    ...
    public void testCreateUser() {
        ...
        toBeCreatedUser.setBusinessNumber("+12 345 67890");
        ...
        Assert.assertEquals("User \"newuser\" does not have a the correct phone attribute stored being saved", "+12 345 67890", freshlyCreatedUser.getBusinessNumber());
